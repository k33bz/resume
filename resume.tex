...
\section{EDUCATION}
			...
			Bachelor of Science in Computer Science, obtained December 2014
...
\section{EMPLOYMENT}
            ...
            \begin{itemize}[noitemsep,nolistsep,leftmargin=0.16cm]
                ...
                \item[] Maintained and improved UCF College of Medicine web applications
                    using {\bf C\#} and {\bf Razor}. Worked on new development using
					{\bf MVC} and did work following the {\bf Scrum agile framework.}
					Was also responsible for bug testing and fixes of new and existing
					solutions, as well as helped develop and test through programming
					test plans.
            \end{itemize}
			\begin{tabular}{p{3in} r}
